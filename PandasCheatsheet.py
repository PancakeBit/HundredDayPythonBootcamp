Cheatsheet taken from https://gist.github.com/why-not/4582705
not meant to be ran
keeping it as py file for pycharm colors
...
df[df['result'] == 'wrong'].groupby('classification')['classification'].count().reset_index(
